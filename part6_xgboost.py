...
for i, (t1, t2, s1, s2) in enumerate(splits):
    ...
    #interpretation - ARIMA performs poorly with high errors, negative R², and very low directional accuracy, 
    # indicating it fails to capture the trend and dynamics of the data, making it unsuitable for this prediction task.