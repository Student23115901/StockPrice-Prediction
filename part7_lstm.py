...
for i, (t1, t2, s1, s2) in enumerate(splits):
    ...
    #LSTM achieves strong predictive performance with high R² and slightly improved directional accuracy, 
    # but does not significantly outperform Linear Regression on this dataset.